...
(function main() { "use strict";
	...
	// Particle Pool ---------------------------------------------------------
		...
		function ParticlePool(poolSize) {
			...
			this.spriteTextureSignal = THREE.ImageUtils.loadTexture( "neural/sprites/electric.png" );
	...
	// Neural Network --------------------------------------------------------
		...
		NeuralNetwork.prototype.initNeuralNetwork = function () {
			...
			loader.load('neural/models/brain_vertex_low.obj', function constructNeuralNetwork(loadedObject) {
